...
For ordered, use a distance of 1 ( no words between pairs in phrase max), for unordered, 
use a window width 3*|Q| (three times the length of the query). 
Please run these queries with each of the operators: 
SUM, AND, OR, MAX. Use dirichlet smoothing with μ=1500 for all runs.
 */
public class TestInferenceNetwork {
	...
	public static void main(String[] args) {
		...
		//unordered
		outfile = "uw3x.trecrun";
		runId = "dafisher-uw3x-dir-1500";
		qNum = 0;
		for (String query : queries) {
			qNum++;
			// make each of the required query nodes and run the queries
